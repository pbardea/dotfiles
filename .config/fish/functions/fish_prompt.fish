...
# #     https://github.com/Lokaltog/powerline-fonts # # For more advanced awesome, install a nerd fonts patched font (and be sure to
...
function fish_prompt -d 'bobthefish, a fish theme optimized for awesome'
  ...
  switch "$theme_color_scheme"
    ...
    case '*' # default dark theme
      ...
      set __color_vi_mode_default          $grey[2] $grey[3] --bold
      set __color_vi_mode_insert           $blue[1] $grey[3] --bold
      set __color_vi_mode_visual           $orange[1] $orange[3] --bold
